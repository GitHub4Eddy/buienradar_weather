...
function QuickApp:getWeatherData()
   ...
   http:request(url, {
      ...
      success = function(response)
         ...
         self:setGlobalVariable("Buitenradar_Shortterm_"..plugin.mainDeviceId,jsonTable.forecast.shortterm)
         self:setGlobalVariable("Buitenradar_Longterm_"..plugin.mainDeviceId,jsonTable.forecast.longterm)
         self:setGlobalVariable("Buitenradar_Fivedayforecast_1_"..plugin.mainDeviceId,jsonTable.forecast.fivedayforecast[1])
         self:setGlobalVariable("Buitenradar_Fivedayforecast_2_"..plugin.mainDeviceId,jsonTable.forecast.fivedayforecast[2])
         self:setGlobalVariable("Buitenradar_Fivedayforecast_3_"..plugin.mainDeviceId,jsonTable.forecast.fivedayforecast[3])
         self:setGlobalVariable("Buitenradar_Fivedayforecast_4_"..plugin.mainDeviceId,jsonTable.forecast.fivedayforecast[4])
         self:setGlobalVariable("Buitenradar_Fivedayforecast_5_"..plugin.mainDeviceId,jsonTable.forecast.fivedayforecast[5])
         self:setGlobalVariable("Buitenradar_Weatherreport_"..plugin.mainDeviceId,jsonTable.forecast.weatherreport)
   ...
   for i in pairs(data.actual.stationmeasurements) do 
       ...
       if stationid == data.actual.stationmeasurements[i].stationid then
         ...
         -- Save Station specific weather values to Global Variable
          self:setGlobalVariable("Buitenradar_Station_"..plugin.mainDeviceId,data.actual.stationmeasurements[i])
